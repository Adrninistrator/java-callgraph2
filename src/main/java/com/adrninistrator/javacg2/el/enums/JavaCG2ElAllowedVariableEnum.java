...
public enum JavaCG2ElAllowedVariableEnum implements ElAllowedVariableInterface {
    ...
    EAVE_MF_ABSOLUTE_FILE_DIR_PATH_IN_DIR("file_dir_path", JavaCG2CommonNameConstants.SIMPLE_CLASS_NAME_STRING,
    ...
    EAVE_MF_FILE_DIR_PATH_IN_JAR_WAR("file_dir_path", JavaCG2CommonNameConstants.SIMPLE_CLASS_NAME_STRING,
