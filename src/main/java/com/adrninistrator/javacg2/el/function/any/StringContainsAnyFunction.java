 ...
 * @description:
 */
public class StringContainsAnyFunction extends AbstractStringAnyFunction {

    @Override
    public String getName() {
        return ElStringAnyFunctionEnum.CONTAINS_ANY.getName();
    }

    @Override
    protected boolean checkString(String arg0, String argN) {
        return StringUtils.contains(arg0, argN);
    }
}
