...
public class JavaCG2CommonNameConstants {
    ...
    public static final String CLASS_NAME_LAMBDA_META_FACTORY = LambdaMetafactory.class.getName();
    ...
    public static final String METHOD_NAME_DO_IN_TRANSACTION = "doInTransaction";
    public static final String METHOD_NAME_DO_IN_TRANSACTION_WITHOUT_RESULT = "doInTransactionWithoutResult";

    public static final String METHOD_NAME_META_FACTORY = "metafactory";
