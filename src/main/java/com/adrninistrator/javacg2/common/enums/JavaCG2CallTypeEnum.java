...
public enum JavaCG2CallTypeEnum {
    ...
    JavaCG2CallTypeEnum(String type, boolean noInstructionExtendsImpl, boolean childCallSuper, boolean initMethodCall, boolean runInOtherThread, boolean runInSpringTx,
                        String desc) {
        this.type = type;
