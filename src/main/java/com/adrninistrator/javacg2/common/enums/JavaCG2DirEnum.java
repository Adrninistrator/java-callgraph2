...
public enum JavaCG2DirEnum {
    ...
    IDE_PARSE_METHOD_CALL_SWITCH("_javacg2_parse_method_call_switch", "解析方法调用相关开关配置文件所在目录", true),
    IDE_HANDLE_XML_SWITCH("_javacg2_handle_xml_switch", "处理XML文件开关配置文件所在目录", true),
    IDE_EL_EXAMPLE("_el_example", "el表达式示例配置文件所在目录", true),
    IDE_FAIL_CLASSES("javacg2_fail_classes", "el表达式配置说明文件所在目录", false),
    ;
