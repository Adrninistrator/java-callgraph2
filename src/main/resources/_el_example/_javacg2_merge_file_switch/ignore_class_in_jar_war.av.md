...
## 3.1. 合并jar文件中的class文件判断文件所在目录相对路径
...
## 3.2. 合并war文件中的class文件判断文件所在目录相对路径
...
## 5.1. 合并jar文件中的class文件判断class文件相对路径
...
## 5.2. 合并war文件中的class文件判断class文件相对路径
