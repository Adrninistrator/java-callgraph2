 ...
 * @description:
 */
public class TestElParseIgnoreMethodCallTypeValueErMethodArgNum extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_ER_METHOD_ARG_NUM.getVariableName() + " != 5";
    }

    @Override
    protected String chooseTitle() {
        return "方法调用类型与值判断调用方法参数数量";
    }

    @Override
    protected String chooseDesc() {
        return "在解析方法调用被调用对象和参数可能的类型与值时，判断调用方法参数数量是否等于指定值，仅处理匹配的调用方法";
    }
