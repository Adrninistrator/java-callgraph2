 ...
 * @description:
 */
public class TestElParseIgnoreMethodCallTypeValueErSimpleClassName extends TestElBase {
    @Override
    ...
    protected String chooseTitle() {
        return "方法调用类型与值判断调用简单类名";
    }

    @Override
    protected String chooseDesc() {
        return "在解析方法调用被调用对象和参数可能的类型与值时，判断调用简单类名是否等于指定关键字，仅处理匹配的调用方法";
    }
