 ...
 * @description:
 */
public class TestElMergeFileIgnoreClassInJarFN extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "!string.startsWith(" + JavaCG2ElAllowedVariableEnum.EAVE_MF_FILE_NAME.getVariableName() + ", 'Test')";
    }

    @Override
    protected String chooseTitle() {
        return "合并jar文件中的class文件判断文件名";
    }

    @Override
    protected String chooseDesc() {
        return "在合并jar文件中的class文件时，判断文件名是否以指定关键字开头，仅处理匹配的文件";
    }
