 ...
 * @description:
 */
public class TestElMergeFileIgnoreJarInWarFN extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.startsWith(" + JavaCG2ElAllowedVariableEnum.EAVE_MF_FILE_NAME.getVariableName() + ", 'bcel-')";
    }

    @Override
    protected String chooseTitle() {
        return "合并war文件中的jar文件判断文件名";
    }

    @Override
    protected String chooseDesc() {
        return "在合并war文件中的jar文件时，判断文件名是否以指定关键字开头，忽略匹配的文件";
    }
