 ...
 * @description:
 */
public class TestElMergeFileIgnoreOtherInDirFN extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.endsWith(" + JavaCG2ElAllowedVariableEnum.EAVE_MF_FILE_NAME.getVariableName() + ", '.xml')";
    }

    @Override
    protected String chooseTitle() {
        return "合并目录中的其他文件判断文件名";
    }

    @Override
    protected String chooseDesc() {
        return "在合并目录中的其他文件时，判断文件名是否以指定关键字结尾，忽略匹配的文件";
    }
