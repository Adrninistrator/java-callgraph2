 ...
 * @description:
 */
public class TestElMergeFileIgnoreOtherInDirOFE extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return JavaCG2ElAllowedVariableEnum.EAVE_MF_OTHER_FILE_EXT.getVariableName() + " == '.xml'";
    }

    @Override
    protected String chooseTitle() {
        return "合并目录中的其他文件判断文件后缀";
    }

    @Override
    protected String chooseDesc() {
        return "在合并目录中的其他文件时，判断文件后缀是否等于指定关键字，忽略匹配的文件";
    }
