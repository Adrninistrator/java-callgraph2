 ...
 * @description:
 */
public class TestElMergeFileIgnoreOtherInJarFDPIJW extends TestElBase {
    @Override
    ...
    protected String chooseTitle() {
        return "合并jar文件中的其他文件判断文件所在目录相对路径";
    }

    @Override
    protected String chooseDesc() {
        return "在合并jar文件中的其他文件文件时，判断文件所在目录相对路径（相对根目录）是否等于指定关键字，仅处理匹配的文件";
    }
