 ...
 * @description:
 */
public class TestElParseIgnoreMethodCallEeMethodName extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_EE_METHOD_NAME.getVariableName() + " != 'test5'";
    }
    ...
    protected String chooseDesc() {
        return "在解析方法调用时，判断被调用方法名是否等于指定关键字，仅处理匹配的方法调用";
    }
