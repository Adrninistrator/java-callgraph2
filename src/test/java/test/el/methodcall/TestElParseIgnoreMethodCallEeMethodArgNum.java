 ...
 * @description:
 */
public class TestElParseIgnoreMethodCallEeMethodArgNum extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_EE_METHOD_ARG_NUM.getVariableName() + " != 5";
    }

    @Override
    protected String chooseTitle() {
        return "方法调用判断被调用方法参数数量";
    }

    @Override
    protected String chooseDesc() {
        return "在解析方法调用时，判断被调用方法参数数量是否等于指定值，仅处理匹配的方法调用";
    }
