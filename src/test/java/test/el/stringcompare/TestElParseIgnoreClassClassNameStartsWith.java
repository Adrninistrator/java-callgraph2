 ...
 * @description:
 */
public class TestElParseIgnoreClassClassNameStartsWith extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.startsWith(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'test.callgraph.annotation.CallMethodWithAnnotation')";
    }
    ...
    protected String chooseDesc() {
        return "在解析类时，判断类名是否以指定关键字开头，忽略匹配的类";
    }
