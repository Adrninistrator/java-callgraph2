 ...
 * @description:
 */
public class TestElParseIgnoreClassClassNameEqualsAny extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.equalsAny(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'test.callgraph.annotation.CallMethodWithAnnotation'" +
    ...
    protected String chooseDesc() {
        return "在解析类时，判断类名是否等于指定多个关键字之一，忽略匹配的类";
    }
