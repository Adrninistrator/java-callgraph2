 ...
 * @description:
 */
public class TestElParseIgnoreClassClassNameContains extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.contains(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'test.callgraph.annotation.CallMethodWithAnnotation')";
    }
    ...
    protected String chooseDesc() {
        return "在解析类时，判断类名是否包含指定关键字，忽略匹配的类";
    }
