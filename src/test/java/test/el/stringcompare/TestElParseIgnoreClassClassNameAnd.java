 ...
 * @description:
 */
public class TestElParseIgnoreClassClassNameAnd extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.startsWith(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'test.callgraph.annotation.') && " +
                "string.endsWith(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'CallMethodWithAnnotation')";
    }
    ...
    protected String chooseDesc() {
        return "在解析类时，多个条件使用与运算，判断类名是否以指定关键字开头，且以指定关键字结尾，忽略匹配的类";
    }
