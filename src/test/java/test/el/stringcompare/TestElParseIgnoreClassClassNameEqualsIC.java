 ...
 * @description:
 */
public class TestElParseIgnoreClassClassNameEqualsIC extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.equalsIC(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'test.callgraph.annotation.CallMethodWithAnnotation')";
    }
    ...
    protected String chooseDesc() {
        return "在解析类时，判断类名是否等于指定关键字（忽略大小写），忽略匹配的类";
    }
