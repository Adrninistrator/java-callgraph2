 ...
 * @description:
 */
public class TestElParseIgnoreClassClassNameEndsWithAny extends TestElBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.endsWithAny(" + JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + ", 'test.callgraph.annotation.CallMethodWithAnnotation'" +
    ...
    protected String chooseDesc() {
        return "在解析类时，判断类名是否以指定多个关键字之一结尾，忽略匹配的类";
    }
