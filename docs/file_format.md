...
## 1.44. MyBatis的XML中select的字段信息（使用MySQL）
...
## 1.45. MyBatis的XML中update set子句的字段信息（使用MySQL）
...
## 1.46. MyBatis Mapper方法操作的数据库表信息（使用MySQL）
...
## 1.47. MyBatis的XML中where子句的字段信息（使用MySQL）
...
## 1.48. MyBatis Mapper方法写的数据库表信息（使用MySQL）
...
## 1.53. static、final字段初始化方法信息（含枚举）
